...
class RPQ_Instance:
    ...
    def load_from_file(file_path):
        ...
        for i in range(number_of_task):
            ...
            rpq = RPQ_Task(i,prep_time, make_time, deliv_time)
            #AttributeError: 'RPQ_Instance' object has no attribute 'tasks'
            instance.tasks.append(rpq)
        return instance
...
def solve_rpq_with_solver(instance: RPQ_Instance):
    ...
    if (status != cp_model.OPTIMAL): # sprawdzamy status, aby określić czy solver znalazł rozwiązanie optymalne
...
if __name__ == '__main__':
    ...
    test_instance = RPQ_Instance.load_from_file("dane.txt")
